 ...
 * @version 1.0.0
 * @Author: doderick
 * @Date: 2020-02-23 23:05:40
 * @LastEditTime: 2020-03-01 00:07:20
 * @LastEditors: doderick
 * @Description: HTMLPurifier package for ThinkPHP 5.1
 */

namespace Doderick\Purifier;
...
class Purifier
{
    ...
    private function checkCacheDirectory()
    {
        ...
        if ($cachePath && !is_dir($cachePath)) {
            mkdir($cachePath, $this->config->get('purifier.cacheFileMode', 0755), true);
        }
    }
